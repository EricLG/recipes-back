...
export const seedRecipes: SeedRecipe[] = [
    {
        name: 'BOWL CAKE',
        ingredients: [
            { ingredient: 'Banane, pulpe, crue 100 gr', quantity: 80, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 1, unit: 'pièce' },
            { ingredient: 'Miel de printemps', quantity: 0.5, unit: 'càc' },
            { ingredient: 'Lait demi-écrémé', quantity: 50, unit: 'ml' },
            { ingredient: 'Whey nutripure', quantity: 15, unit: 'g' },
            { ingredient: 'Flocons d\'avoine', quantity: 30, unit: 'g' },
            { ingredient: 'Chocolat Pépites Koro 70%', quantity: 10, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Whey nutripure', quantity: 30, unit: 'g' },
            { ingredient: 'Lait demi-écrémé', quantity: 125, unit: 'ml' },
            { ingredient: 'Eau', quantity: 375, unit: 'ml' },
            { ingredient: 'Arôme de banane', quantity: 1, unit: 'dosette' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Banane, pulpe, crue 100 gr', quantity: 80, unit: 'g' },
            { ingredient: 'Petit Suisse 60 gr', quantity: 1, unit: 'pièce' },
            { ingredient: 'Miel de printemps', quantity: 0.5, unit: 'càc' },
            { ingredient: 'Lait demi-écrémé', quantity: 40, unit: 'ml' },
            { ingredient: 'Levure de bière en paillettes', quantity: 2, unit: 'dosette' },
            { ingredient: 'Flocons d\'avoine', quantity: 30, unit: 'g' },
            { ingredient: 'Chocolat Pépites Koro 70%', quantity: 10, unit: 'g' },
            { ingredient: 'Soja crispies au cacao Koro', quantity: 1, unit: 'dosette' },
            { ingredient: 'Psyllium', quantity: 3, unit: 'dosette' },
        ],
    ...
    },
    {
        name: 'GRANOLA BOWL',
        ingredients: [
            { ingredient: 'Petit Suisse 60 gr', quantity: 2, unit: 'pièce' },
            { ingredient: 'Sucre de canne Blond', quantity: 5, unit: 'g' },
            { ingredient: 'Chocolat Pépites Koro 70%', quantity: 10, unit: 'g' },
            { ingredient: 'Soja crispies au cacao Koro', quantity: 1, unit: 'dosette' },
            { ingredient: 'Granola Noix & Graines U Céréales', quantity: 35, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 1200, unit: 'g' },
            { ingredient: 'Poivron rouge, cru', quantity: 150, unit: 'g' },
            { ingredient: 'Fromage de madame Loïc', quantity: 150, unit: 'g' },
            { ingredient: 'Couscous 1/2 complet', quantity: 200, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 80, unit: 'g' },
            { ingredient: 'Parmesan', quantity: 35, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 10, unit: 'ml' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Epices à couscous', quantity: 5, unit: 'g' },
        ],
    ...
    },
    {
        name: 'BOWL CAKE SALÉ',
        ingredients: [
            { ingredient: 'Fromage blanc nature 3% MG (100 gr)', quantity: 100, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 1, unit: 'pièce' },
            { ingredient: 'Flocons d\'avoine', quantity: 45, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 25, unit: 'g' },
    ...
    },
    {
        name: 'COUSCOUS',
        ingredients: [
            { ingredient: 'Carotte', quantity: 360, unit: 'g' },
            { ingredient: 'Poivron rouge, cru', quantity: 160, unit: 'g' },
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 500, unit: 'g' },
            { ingredient: 'Haricots Blanc 280 gr', quantity: 280, unit: 'g' },
            { ingredient: 'Couscous 1/2 complet', quantity: 150, unit: 'g' },
            { ingredient: 'Chipolatas U (par 6, 330 gr)', quantity: 330, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 15, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 100, unit: 'g' },
            { ingredient: 'Ail', quantity: 3, unit: 'gousse' },
            { ingredient: 'Raz-el-Hanout', quantity: 1, unit: 'càc' },
            { ingredient: 'Epices à couscous', quantity: 1, unit: 'càc' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pain de mie U (500 g/24 tranches)', quantity: 20, unit: 'tranches' },
            { ingredient: 'Jambons 4 tranches 140 gr', quantity: 4, unit: 'tranches' },
            { ingredient: 'Fromage Croque emmental x20 - 340 gr', quantity: 10, unit: 'tranches' },
            { ingredient: 'Champignons', quantity: 300, unit: 'g' },
            { ingredient: 'Lait demi-écrémé', quantity: 250, unit: 'ml' },
            { ingredient: 'Beurre demi sel', quantity: 15, unit: 'g' },
            { ingredient: 'Maizena', quantity: 20, unit: 'g' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 600, unit: 'g' },
            { ingredient: 'Farine T65', quantity: 75, unit: 'g' },
            { ingredient: 'Whey nutripure', quantity: 15, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 1, unit: 'pièce' },
            { ingredient: 'Son d\'avoine Markal', quantity: 20, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Jambons 4 tranches 140 gr', quantity: 2, unit: 'tranches' },
            { ingredient: 'Fromage Croque emmental x20 - 340 gr', quantity: 2, unit: 'tranches' },
        ],
    ...
    },
    {
        name: 'CROZIFLETTE',
        ingredients: [
            { ingredient: 'Crozets', quantity: 200, unit: 'g' },
            { ingredient: 'Reblochon petit 240 gr', quantity: 240, unit: 'g' },
            { ingredient: 'Crème liquide entière U bio', quantity: 100, unit: 'ml' },
            { ingredient: 'Dés de jambon Herta Nature  2x75 gr', quantity: 150, unit: 'g' },
            { ingredient: 'Poireau, cru', quantity: 200, unit: 'g' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Patate douce, crue', quantity: 300, unit: 'g' },
            { ingredient: 'Potimarron', quantity: 500, unit: 'g' },
            { ingredient: 'Carotte', quantity: 300, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 50, unit: 'g' },
            { ingredient: 'Paprika', quantity: 1, unit: 'g' },
            { ingredient: 'Flocons d\'avoine', quantity: 100, unit: 'g' },
            { ingredient: 'Farine T65', quantity: 60, unit: 'g' },
            { ingredient: 'Whey nutripure', quantity: 15, unit: 'g' },
            { ingredient: 'Fromage de madame Loïc', quantity: 90, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 25, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 500, unit: 'g' },
            { ingredient: 'Champignons', quantity: 300, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 300, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 100, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 15, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Flocons d\'avoine', quantity: 100, unit: 'g' },
            { ingredient: 'Farine T65', quantity: 60, unit: 'g' },
            { ingredient: 'Whey nutripure', quantity: 15, unit: 'g' },
            { ingredient: 'Fromage tartare', quantity: 90, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 25, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Riz Basmati semi complet', quantity: 200, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Carotte', quantity: 240, unit: 'g' },
            { ingredient: 'Pomme de terre crue', quantity: 250, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 100, unit: 'g' },
            { ingredient: 'Crème liquide entière U bio', quantity: 100, unit: 'ml' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
            { ingredient: 'Sucre de canne Blond', quantity: 5, unit: 'g' },
            { ingredient: 'Curry', quantity: 12, unit: 'g' },
            { ingredient: 'Curcuma', quantity: 3, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Lentilles corails', quantity: 150, unit: 'g' },
            { ingredient: 'Patate douce, crue', quantity: 400, unit: 'g' },
            { ingredient: 'Epinards en branche surgelés', quantity: 200, unit: 'g' },
            { ingredient: 'Crème Soja liquide', quantity: 200, unit: 'ml' },
            { ingredient: 'Quinoa Trio en vrac', quantity: 180, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Gingembre', quantity: 1, unit: 'g' },
            { ingredient: 'Curry', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Butternut', quantity: 500, unit: 'g' },
            { ingredient: 'Dés de jambon Herta Nature  2x75 gr', quantity: 150, unit: 'g' },
            { ingredient: 'Ricotta (250 gr)', quantity: 250, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 1, unit: 'pièce' },
            { ingredient: 'Coquillettes 1/2 Complètes', quantity: 200, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 30, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Gnocchi à poêler U 300 gr', quantity: 300, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 100, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 15, unit: 'ml' },
            { ingredient: 'Sucre de canne Blond', quantity: 5, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Gruyère', quantity: 50, unit: 'g' },
            { ingredient: 'Graines de lin', quantity: 20, unit: 'g' },
            { ingredient: 'Origan', quantity: 1, unit: 'g' },
            { ingredient: 'Paprika', quantity: 1, unit: 'g' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pomme de terre crue', quantity: 500, unit: 'g' },
            { ingredient: 'Dés de jambon Herta Nature  2x75 gr', quantity: 150, unit: 'g' },
            { ingredient: 'Chou frisé', quantity: 500, unit: 'g' },
            { ingredient: 'Crème liquide entière U bio', quantity: 100, unit: 'ml' },
            { ingredient: 'Amandes entières', quantity: 40, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 50, unit: 'g' },
            { ingredient: 'Pomme (fruit)', quantity: 1, unit: 'pièce' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pomme de terre crue', quantity: 1000, unit: 'g' },
            { ingredient: 'Lait demi-écrémé', quantity: 250, unit: 'ml' },
            { ingredient: 'Carotte', quantity: 200, unit: 'g' },
            { ingredient: 'Champignons', quantity: 200, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 130, unit: 'g' },
            { ingredient: 'Lentilles vertes', quantity: 160, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
            { ingredient: 'Gruyère', quantity: 80, unit: 'g' },
        ],
    ...
    },
    {
        name: 'LASAGNES',
        ingredients: [
            { ingredient: 'Viande hachée 5 %', quantity: 350, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 40, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Carotte', quantity: 180, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 30, unit: 'g' },
            { ingredient: 'Lasagnes PANZANI', quantity: 1, unit: 'feuille' },
            { ingredient: 'Lait Entier', quantity: 500, unit: 'ml' },
            { ingredient: 'Beurre demi sel', quantity: 30, unit: 'g' },
            { ingredient: 'Maizena', quantity: 40, unit: 'g' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Haricots Blanc 280 gr', quantity: 280, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 5, unit: 'ml' },
            { ingredient: 'Paprika', quantity: 1, unit: 'g' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Oeuf entier', quantity: 2, unit: 'pièce' },
            { ingredient: 'Pain de mie U (500 g/24 tranches)', quantity: 1, unit: 'tranches' },
            { ingredient: 'Beurre demi sel', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 1200, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 320, unit: 'g' },
            { ingredient: 'Reblochon petit 240 gr', quantity: 240, unit: 'g' },
            { ingredient: 'Blé Ebly portion 65 gr sec', quantity: 125, unit: 'g' },
            { ingredient: 'Lentilles corails', quantity: 100, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
        ],
    ...
    },
    {
        name: 'ONE PAN QUINOA',
        ingredients: [
            { ingredient: 'Quinoa Trio en vrac', quantity: 125, unit: 'g' },
            { ingredient: 'Haricots noirs 230 gr', quantity: 230, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Maïs sans sucre ajouté 140 gr', quantity: 140, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 6, unit: 'pièce' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Poivron rouge, cru', quantity: 50, unit: 'g' },
            { ingredient: 'Bouillon', quantity: 50, unit: 'ml' },
            { ingredient: 'Cumin', quantity: 2.5, unit: 'g' },
            { ingredient: 'Raz-el-Hanout', quantity: 1, unit: 'g' },
            { ingredient: 'Jus de citron', quantity: 1, unit: 'ml' },
            { ingredient: 'Whey nutripure', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Haricots noirs 230 gr', quantity: 230, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Riz Basmati semi complet', quantity: 100, unit: 'g' },
            { ingredient: 'Poulet, blanc, cru', quantity: 200, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 70, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 15, unit: 'ml' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Eau', quantity: 150, unit: 'ml' },
            { ingredient: 'Epices à couscous', quantity: 1, unit: 'g' },
            { ingredient: 'Tempeh à cuisiner 200 gr', quantity: 200, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Haricots Blanc 280 gr', quantity: 280, unit: 'g' },
            { ingredient: 'Crème Soja liquide', quantity: 100, unit: 'ml' },
            { ingredient: 'Beurre de cacahuètes', quantity: 30, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Epinards en branche surgelés', quantity: 80, unit: 'g' },
            { ingredient: 'Miso (sachet 22 gr)', quantity: 22, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 15, unit: 'ml' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Paprika', quantity: 1, unit: 'g' },
            { ingredient: 'Curcuma', quantity: 1, unit: 'g' },
            { ingredient: 'Gingembre', quantity: 1, unit: 'g' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Pain de mie U (500 g/24 tranches)', quantity: 1, unit: 'tranches' },
        ],
    ...
    },
    {
        name: 'POÊLÉ THAÏ',
        ingredients: [
            { ingredient: 'Nouilles en nids', quantity: 125, unit: 'g' },
            { ingredient: 'Crevettes', quantity: 180, unit: 'g' },
            { ingredient: 'Poivron rouge, cru', quantity: 160, unit: 'g' },
            { ingredient: 'Carotte', quantity: 240, unit: 'g' },
            { ingredient: 'Epinards en branche surgelés', quantity: 90, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 65, unit: 'g' },
            { ingredient: 'Petits pois surgelés', quantity: 50, unit: 'g' },
            { ingredient: 'Huile de sésame', quantity: 1, unit: 'ml' },
            { ingredient: 'Échalote', quantity: 1, unit: 'pièce' },
            { ingredient: 'Cumin', quantity: 1, unit: 'g' },
            { ingredient: 'Curcuma', quantity: 1, unit: 'g' },
            { ingredient: 'Gingembre', quantity: 1, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Coquillettes 1/2 Complètes', quantity: 220, unit: 'g' },
            { ingredient: 'Chou-fleur surgelé', quantity: 450, unit: 'g' },
            { ingredient: 'Lait demi-écrémé', quantity: 100, unit: 'ml' },
            { ingredient: 'Huile de tournesol', quantity: 30, unit: 'ml' },
            { ingredient: 'Parmesan', quantity: 50, unit: 'g' },
            { ingredient: 'Poulet, blanc, cru', quantity: 400, unit: 'g' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Poulet, blanc, cru', quantity: 400, unit: 'g' },
            { ingredient: 'Champignons', quantity: 200, unit: 'g' },
            { ingredient: 'Petits pois surgelés', quantity: 100, unit: 'g' },
            { ingredient: 'Epinards en branche surgelés', quantity: 100, unit: 'g' },
            { ingredient: 'Poivron grillés à l\'huile 190 gr', quantity: 240, unit: 'g' },
            { ingredient: 'Lait Entier', quantity: 125, unit: 'ml' },
            { ingredient: 'Fromage de madame Loïc', quantity: 90, unit: 'g' },
            { ingredient: 'Parmesan', quantity: 30, unit: 'g' },
            { ingredient: 'Échalote', quantity: 2, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Nouilles en nids', quantity: 125, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Poulet, blanc, cru', quantity: 400, unit: 'g' },
            { ingredient: 'Brocoli surgelé Bio U', quantity: 250, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Carotte', quantity: 240, unit: 'g' },
            { ingredient: 'Beurre de cacahuètes', quantity: 60, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 10, unit: 'ml' },
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Riz Basmati semi complet', quantity: 200, unit: 'g' },
    ...
    },
    {
        ...
        ingredients: [
            ...
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
            { ingredient: 'Paprika', quantity: 1, unit: 'g' },
            { ingredient: 'Bouillon', quantity: 750, unit: 'ml' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pâte brisée maison (280 gr)', quantity: 1, unit: 'pièce' },
            { ingredient: 'Champignons', quantity: 500, unit: 'g' },
            { ingredient: 'Bacon fumé JUSTIN BRIDOU, 16 tranches soit 160g', quantity: 80, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 3, unit: 'pièce' },
            { ingredient: 'Lait Entier', quantity: 200, unit: 'ml' },
            { ingredient: 'Maizena', quantity: 20, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 80, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pâte brisée maison (280 gr)', quantity: 1, unit: 'pièce' },
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 300, unit: 'g' },
            { ingredient: 'Aubergine, pulpe et peau, rôtie/cuite au four', quantity: 300, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 300, unit: 'g' },
            { ingredient: 'Mozarella', quantity: 250, unit: 'g' },
            { ingredient: 'Fromage de madame Loïc', quantity: 90, unit: 'g' },
            { ingredient: 'Origan', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pâte brisée maison (280 gr)', quantity: 1, unit: 'pièce' },
            { ingredient: 'Carotte', quantity: 120, unit: 'g' },
            { ingredient: 'Champignons', quantity: 300, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 4, unit: 'pièce' },
            { ingredient: 'Jambons 4 tranches 140 gr', quantity: 2, unit: 'tranches' },
            { ingredient: 'Fromage blanc nature 3% MG (100 gr)', quantity: 300, unit: 'g' },
            { ingredient: 'Lait Entier', quantity: 100, unit: 'ml' },
            { ingredient: 'Gruyère', quantity: 60, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Coquillettes 1/2 Complètes', quantity: 220, unit: 'g' },
            { ingredient: 'Poulet, blanc, cru', quantity: 400, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 250, unit: 'g' },
            { ingredient: 'Parmesan', quantity: 40, unit: 'g' },
            { ingredient: 'Amandes entières', quantity: 30, unit: 'g' },
            { ingredient: 'Fromage blanc nature 3% MG (100 gr)', quantity: 100, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 10, unit: 'g' },
            { ingredient: 'Levure de bière en paillettes', quantity: 6, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pâte brisée maison (280 gr)', quantity: 1, unit: 'pièce' },
            { ingredient: 'Courgette, pulpe et peau, crue', quantity: 500, unit: 'g' },
            { ingredient: 'Poireau, cru', quantity: 250, unit: 'g' },
            { ingredient: 'Ricotta (250 gr)', quantity: 250, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 2, unit: 'pièce' },
            { ingredient: 'Dés de jambon Herta Nature  2x75 gr', quantity: 150, unit: 'g' },
            { ingredient: 'Lait Entier', quantity: 100, unit: 'ml' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Coquillettes 1/2 Complètes', quantity: 240, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 250, unit: 'g' },
            { ingredient: 'Pesto aux fanes de radis (maison)', quantity: 60, unit: 'g' },
            { ingredient: 'Vinaigre balsamique', quantity: 15, unit: 'ml' },
            { ingredient: 'Mozarella', quantity: 250, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pomme de terre crue', quantity: 800, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 400, unit: 'g' },
            { ingredient: 'Oeuf entier', quantity: 8, unit: 'pièce' },
            { ingredient: 'Rôti de porc FLEURY MICHON 210 gr 6 tranches', quantity: 140, unit: 'g' },
            { ingredient: 'Cornichons', quantity: 1, unit: 'pièce' },
            { ingredient: 'Sel', quantity: 1, unit: 'g' },
            { ingredient: 'Poivre', quantity: 1, unit: 'g' },
            { ingredient: 'Ciboulette', quantity: 1, unit: 'g' },
            { ingredient: 'Herbe de provence', quantity: 1, unit: 'g' },
            { ingredient: 'Fromage blanc nature 3% MG (100 gr)', quantity: 300, unit: 'g' },
            { ingredient: 'Mayonnaise', quantity: 40, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 20, unit: 'g' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Jus de citron', quantity: 10, unit: 'ml' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Pois cassés (230 gr)', quantity: 230, unit: 'g' },
            { ingredient: 'Tomates entières en conserve 400 g', quantity: 240, unit: 'g' },
            { ingredient: 'Carotte', quantity: 300, unit: 'g' },
            { ingredient: 'Chou frisé', quantity: 100, unit: 'g' },
            { ingredient: 'Parmesan', quantity: 40, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 1, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Riz Basmati semi complet', quantity: 240, unit: 'g' },
            { ingredient: 'Thon entier au naturel 140 gr', quantity: 215, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 400, unit: 'g' },
            { ingredient: 'Maïs sans sucre ajouté 140 gr', quantity: 140, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 1, unit: 'g' },
            { ingredient: 'Fromage blanc nature 3% MG (100 gr)', quantity: 300, unit: 'g' },
            { ingredient: 'Mayonnaise', quantity: 40, unit: 'g' },
            { ingredient: 'Moutarde', quantity: 20, unit: 'g' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Riz Basmati semi complet', quantity: 150, unit: 'g' },
            { ingredient: 'Patate douce, crue', quantity: 320, unit: 'g' },
            { ingredient: 'Carotte', quantity: 240, unit: 'g' },
            { ingredient: 'Champignons', quantity: 200, unit: 'g' },
            { ingredient: 'Protéines de soja Vantastic', quantity: 90, unit: 'g' },
            { ingredient: 'Lait Entier', quantity: 300, unit: 'ml' },
            { ingredient: 'Whey nutripure', quantity: 30, unit: 'g' },
            { ingredient: 'Bouillon', quantity: 1000, unit: 'ml' },
            { ingredient: 'Huile de tournesol', quantity: 30, unit: 'ml' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 1, unit: 'gousse' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Viande hachée 5 %', quantity: 350, unit: 'g' },
            { ingredient: 'Tomate grappe, crue', quantity: 600, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Son d\'avoine Markal', quantity: 25, unit: 'g' },
            { ingredient: 'Nouilles en nids', quantity: 250, unit: 'g' },
    ...
    },
    {
        ...
        ingredients: [
            { ingredient: 'Tortilla de blé nature (grande 41 gr)', quantity: 8, unit: 'pièce' },
            { ingredient: 'Viande hachée 5 %', quantity: 350, unit: 'g' },
            { ingredient: 'Champignons', quantity: 300, unit: 'g' },
            { ingredient: 'Double concentré de tomates 3x70g', quantity: 70, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 100, unit: 'g' },
            { ingredient: 'Oignon', quantity: 1, unit: 'pièce' },
            { ingredient: 'Ail', quantity: 2, unit: 'gousse' },
            { ingredient: 'Paprika', quantity: 5, unit: 'g' },
            { ingredient: 'Piment', quantity: 1, unit: 'pincée' },
        ],
    ...
    },
    {
        ...
        ingredients: [
            ...
            { ingredient: 'Concombre, pulpe, cru', quantity: 300, unit: 'g' },
            { ingredient: 'Huile de tournesol', quantity: 30, unit: 'ml' },
            { ingredient: 'Jus de citron', quantity: 30, unit: 'ml' },
            { ingredient: 'Vinaigre de cidre', quantity: 15, unit: 'ml' },
            { ingredient: 'Origan', quantity: 1, unit: 'g' },
        ],
    ...
    },
    {
        name: 'WRAP FROID',
        ingredients: [
            { ingredient: 'Tortilla de blé complete (géante 58 gr)', quantity: 4, unit: 'pièce' },
            { ingredient: 'Jambons 4 tranches 140 gr', quantity: 4, unit: 'tranches' },
            { ingredient: 'Fromage de madame Loïc', quantity: 150, unit: 'g' },
            { ingredient: 'Gruyère', quantity: 80, unit: 'g' },
            { ingredient: 'Carotte', quantity: 300, unit: 'g' },
            { ingredient: 'Concombre, pulpe, cru', quantity: 300, unit: 'g' },
            { ingredient: 'Maïs sans sucre ajouté 140 gr', quantity: 140, unit: 'g' },
            { ingredient: 'Laitue', quantity: 1, unit: 'feuille' },
        ],
